...
Translation Exchange API for your WordPress site.

== Description ==
This API plugin allows Translation Exchange to integrate with your localization plugin in minutes.

Import content, translate and publish it right back.
